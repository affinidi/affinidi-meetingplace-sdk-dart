...
abstract interface class ChatSDK {
  ...
  /// Creates a local chat message for a credential issued to the other party.
  ///
  /// Persists the message and emits it to the chat stream so the sender sees
  /// an attachment tile immediately (isFromMe: true).
  ...
  /// party.
  ///
  /// Persists the message and emits it to the chat stream so the receiver sees
  /// an attachment tile immediately (isFromMe: false).
