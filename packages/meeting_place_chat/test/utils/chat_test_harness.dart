...
/// Helpers for integration tests that subscribe to a [ChatSDK]'s event
/// stream. Replaces ad-hoc `Completer<void>` + `stream.listen` patterns with
/// typed, named waits whose timeout errors point at the calling test.
