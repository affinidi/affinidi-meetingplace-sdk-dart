...
@BuiltValue()
abstract class AcceptOfferOK
    implements Built<AcceptOfferOK, AcceptOfferOKBuilder> {
  ...
  factory AcceptOfferOK([void updates(AcceptOfferOKBuilder b)]) =
      _$AcceptOfferOK;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AcceptOfferOKBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AcceptOfferOK> get serializer =>
      _$AcceptOfferOKSerializer();
}

class _$AcceptOfferOKSerializer implements PrimitiveSerializer<AcceptOfferOK> {
  @override
  final Iterable<Type> types = const [AcceptOfferOK, _$AcceptOfferOK];

  @override
  final String wireName = r'AcceptOfferOK';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AcceptOfferOK object, {
  ...
  void _deserializeProperties(
    ...
    required AcceptOfferOKBuilder result,
  ...
  @override
  AcceptOfferOK deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AcceptOfferOKBuilder();
