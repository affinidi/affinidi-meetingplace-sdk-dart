...
part of 'accept_offer_ok.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AcceptOfferOK extends AcceptOfferOK {
  @override
  final String? status;
  @override
  ...
  @override
  AcceptOfferOKBuilder toBuilder() => AcceptOfferOKBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AcceptOfferOK &&
        status == other.status &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AcceptOfferOK')
          ..add('status', status)
          ..add('message', message)
...
class AcceptOfferOKBuilder
    implements Builder<AcceptOfferOK, AcceptOfferOKBuilder> {
  _$AcceptOfferOK? _$v;
  ...
  AcceptOfferOKBuilder() {
    AcceptOfferOK._defaults(this);
  }

  AcceptOfferOKBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _status = $v.status;
      _message = $v.message;
  ...
  @override
  void replace(AcceptOfferOK other) {
    _$v = other as _$AcceptOfferOK;
  }

  @override
  void update(void Function(AcceptOfferOKBuilder)? updates) {
