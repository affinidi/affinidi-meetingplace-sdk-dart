...
part 'notify_accept_offer_input.g.dart';
...
@BuiltValue()
abstract class NotifyAcceptOfferInput
    implements Built<NotifyAcceptOfferInput, NotifyAcceptOfferInputBuilder> {
  ...
  NotifyAcceptOfferInput._();

  factory NotifyAcceptOfferInput(
          [void updates(NotifyAcceptOfferInputBuilder b)]) =
      _$NotifyAcceptOfferInput;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotifyAcceptOfferInputBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotifyAcceptOfferInput> get serializer =>
      _$NotifyAcceptOfferInputSerializer();
}

class _$NotifyAcceptOfferInputSerializer
    implements PrimitiveSerializer<NotifyAcceptOfferInput> {
  @override
  ...
  @override
  final String wireName = r'NotifyAcceptOfferInput';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    NotifyAcceptOfferInput object, {
  ...
  void _deserializeProperties(
    ...
    required NotifyAcceptOfferInputBuilder result,
  ...
  @override
  NotifyAcceptOfferInput deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = NotifyAcceptOfferInputBuilder();
