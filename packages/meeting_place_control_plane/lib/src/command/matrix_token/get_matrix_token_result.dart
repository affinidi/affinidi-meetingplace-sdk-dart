...
import 'matrix_token_request.dart' show MatrixTokenRequest;

/// The result returned when a Matrix login token is requested.
/// Output of [MatrixTokenRequest].
class GetMatrixTokenResult {
  /// Creates a new instance of [GetMatrixTokenResult].
  GetMatrixTokenResult({required this.token});
