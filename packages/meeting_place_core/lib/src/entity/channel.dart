...
class Channel {
  ...
  /// The Matrix room ID for the channel.
  /// Set when the channel room is joined during inauguration so that
  /// later lookups (e.g. for video calls) can resolve the room directly
  /// without relying on alias registration.
  String? matrixRoomId;
