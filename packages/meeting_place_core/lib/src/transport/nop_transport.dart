...
/// Default no-op channel transport used when no [channelTransportFactory] is
/// provided to [MeetingPlaceCoreSDK.create]. All channel operations are
/// silently ignored; media operations throw [UnimplementedError].
