...
Future<void> main() async {
  ...
  credentialsSDK.receivedVrcRequests.listen((request) async {
  ...
  credentialsSDK.receivedVrcs.listen((issuance) {
  ...
  const mnemonicFile = '.example-output/credentials-storage.txt';
