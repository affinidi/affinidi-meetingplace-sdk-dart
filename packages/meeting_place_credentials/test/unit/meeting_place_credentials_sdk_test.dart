...
void main() {
  ...
  group('MeetingPlaceCredentialsSDK', () {
    ...
    late MeetingPlaceCredentialsSDK sdk;
  ...
  group('MeetingPlaceCredentialsSDK R-Card stream wiring', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
    late MockRCardRepository mockRepo;
    late MockVrcRepository mockVrcRepo;
    late StreamController<ChannelAttachmentEvent> channelAttachmentsCtrl;
  ...
  group('MeetingPlaceCredentialsSDK VRC streams', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
    late MockRCardRepository mockRepo;
    late MockVrcRepository mockVrcRepo;
    late StreamController<ChannelAttachmentEvent> channelAttachmentsCtrl;
  ...
  group('MeetingPlaceCredentialsSDK VRC persistence', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
    ...
    test('storeVrc throws MeetingPlaceCredentialsSDKException '
  ...
  group('MeetingPlaceCredentialsSDK VRC protocol helpers', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
  ...
  group('MeetingPlaceCredentialsSDK.parseVrc', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
    late MockRCardRepository mockRepo;
    late MockVrcRepository mockVrcRepo;
    late StreamController<ChannelAttachmentEvent> channelAttachmentsCtrl;
  ...
  group('MeetingPlaceCredentialsSDK.sendRCard', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
  ...
  group('MeetingPlaceCredentialsSDK CRUD delegation', () {
    late MockMeetingPlaceCoreSDK mockCoreSDK;
    late MockRCardRepository mockRepo;
    late StreamController<ChannelAttachmentEvent> channelAttachmentsCtrl;
    late StreamController<PlainTextMessage> vdipMessagesCtrl;
    ...
    MeetingPlaceCredentialsSDK buildSdk() => MeetingPlaceCredentialsSDK(
      coreSDK: mockCoreSDK,
      rCardRepository: mockRepo,
      vrcRepository: stubbedMockVrcRepository(),
    );
