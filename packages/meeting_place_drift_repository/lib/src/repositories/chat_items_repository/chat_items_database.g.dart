...
class $ChatItemsTable extends ChatItems
  ...
  static const VerificationMeta _conciergeTypeMeta = const VerificationMeta(
    'conciergeType',
  );
  @override
  ...
  ChatItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatItem(
      ...
      conciergeType: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class ChatItem extends DataClass implements Insertable<ChatItem> {
  ...
  ChatItem copyWith({
    ...
    conciergeType: conciergeType.present
        ? conciergeType.value
        : this.conciergeType,
...
class Attachment extends DataClass implements Insertable<Attachment> {
  ...
  AttachmentsCompanion toCompanion(bool nullToAbsent) {
    return AttachmentsCompanion(
      ...
      base64: base64 == null && nullToAbsent
          ? const Value.absent()
          : Value(base64),
...
typedef $$ChatItemsTableCreateCompanionBuilder =
    ChatItemsCompanion Function({
      required String chatId,
      required String messageId,
      Value<String?> value,
      Value<bool> isFromMe,
...
final class $$ChatItemsTableReferences
  ...
  _reactionsRefsTable(_$ChatItemsDatabase db) => MultiTypedResultKey.fromTable(
    db.reactions,
...
class $$ChatItemsTableTableManager
    extends
        RootTableManager<
          _$ChatItemsDatabase,
          $ChatItemsTable,
...
typedef $$ChatItemsTableProcessedTableManager =
...
final class $$AttachmentsLinksTableReferences
    extends
        BaseReferences<
          _$ChatItemsDatabase,
...
class $$AttachmentsLinksTableTableManager
    extends
        RootTableManager<
          _$ChatItemsDatabase,
          $AttachmentsLinksTable,
...
typedef $$AttachmentsLinksTableProcessedTableManager =
    ProcessedTableManager<
      _$ChatItemsDatabase,
      $AttachmentsLinksTable,
      AttachmentLink,
