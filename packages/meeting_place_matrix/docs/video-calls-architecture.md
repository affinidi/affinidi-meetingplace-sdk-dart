...
meeting_place_matrix ← Flutter plugin. implements those interfaces.
...
graph TD
    ...
    subgraph Plugin["meeting_place_matrix"]
...
### SDK — `meeting_place_matrix`

| Area | Status |
|---|---|
| Plugin package scaffold (`meeting_place_matrix`) | ✅ Done |
