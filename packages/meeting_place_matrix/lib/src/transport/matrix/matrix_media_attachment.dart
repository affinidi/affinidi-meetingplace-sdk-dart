...
class MatrixEventField {
  ...
  /// Carries the call session ID in `mpx.call.started` room events so
  /// receivers can associate the event's homeserver timestamp with the
  /// correct call.
  static const callId = 'mp_call_id';
