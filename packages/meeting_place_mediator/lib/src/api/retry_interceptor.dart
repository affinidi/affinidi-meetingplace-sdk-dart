...
/// [RetryInterceptor] intercepts and handles HTTP requests by automatically
/// retrying failed requests based on specific conditions.
///
/// **Parameters:**
/// - [dio]: The Dio instance used to perform HTTP requests and retries.
/// - [maxRetries]: The maximum number of times a request will be retried after
///   failure.
