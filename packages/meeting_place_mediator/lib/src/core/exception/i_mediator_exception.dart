...
///   or error.
/// - [code]: An enumeration value representing the type or category
///   of the error for easier classification.
/// - [innerException]: Holds the original exception or error object.
abstract interface class IMediatorException implements Exception {
  String get message;
