...
class MessageUnpacker {
  ...
  /// Unpacks a DIDComm message to a PlainTextMessage with automatic retry on
  /// failure.
  ///
  /// **Parameters:**
  /// - [message]: The encrypted DIDComm message to unpack.
  /// - [recipientDidManager]: The DidManager instance for the message
  ///   recipient.
  /// - [expectedMessageWrappingTypes]: Optional list of expected message
  ///   wrapping types.
  ///
  ...
  static Future<PlainTextMessage> unpackWithRetry({
    ...
    void Function(Exception e)? onRetry,
  }) async {
    return retry(
      () async {
