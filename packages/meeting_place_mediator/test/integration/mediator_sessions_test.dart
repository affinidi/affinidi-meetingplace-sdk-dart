...
void main() {
  ...
  test(
    'Multiple authentications with the same did use the same session',
    () async {
      final clientA = await fixture.sdk.authenticateWithDid(
        fixture.didManagerA,
      );
      final clientB = await fixture.sdk.authenticateWithDid(
        fixture.didManagerA,
      );
