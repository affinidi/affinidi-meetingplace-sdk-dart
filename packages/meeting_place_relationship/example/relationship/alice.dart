...
Future<void> main() async {
  ...
  relationshipSDK.receivedVrcRequests.listen((_) {
  ...
  relationshipSDK.receivedVrcs.listen((issuance) async {
  ...
  File(
    '${outputDir.path}/relationship-storage.txt',
  ...
  prettyPrintYellow(
    'Mnemonic written → .example-output/relationship-storage.txt',
  );
  prettyPrint('Run relationship/bob.dart now in a separate terminal.');
