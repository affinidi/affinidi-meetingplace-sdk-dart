...
final class LivenessProofPayload {
  ...
  Map<String, dynamic> toJson() => {
    LivenessZkpConstants.typeJsonKey: LivenessZkpConstants.livenessProofPayloadType,
  ...
  /// If `type` is present it must match [LivenessZkpConstants.livenessProofPayloadType].
  factory LivenessProofPayload.fromJson(Map<String, dynamic> json) {
    ...
    if (type != null && type != LivenessZkpConstants.livenessProofPayloadType) {
      throw FormatException(
        'Unexpected liveness ZKP payload type: $type',
      );
    }
