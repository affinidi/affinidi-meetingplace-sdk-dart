...
import 'package:meeting_place_relationship/src/shared/relationship_vdip_stream_manager.dart';
import 'package:ssi/ssi.dart';
import 'package:test/test.dart';

void main() {
  group('RelationshipVdipStreamManager', () {
    ...
    RelationshipVdipStreamManager makeManager(
      StreamController<PlainTextMessage> ctrl,
    ) {
      return RelationshipVdipStreamManager(
        incomingVdipMessages: ctrl.stream,
        logger: DefaultMeetingPlaceCoreSDKLogger(
          className: 'RelationshipVdipStreamManagerTest',
        ),
      );
    }
